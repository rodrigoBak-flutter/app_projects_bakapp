import 'package:app_projects_bakapp/find_out/models/comments.dart';
...
class Place {
  ...
  static final dumpListData = [
    Place(
        ...
        description:
            'Riviera Maya tiene más de 120 km de costa turquesa cristalina, playas de arena blanca, sitios arqueológicos, parques naturales y actividades acuáticas únicas',
        imageUrl: [
    ...
    Place(
        ...
        comments: Comment.defaultListComment,
        description:
            'Tulum fue una ciudad amurallada de la cultura maya ubicada en el Estado de Quintana Roo, en el sureste de México, en la costa del mar Caribe.',
        imageUrl: [
    ...
    Place(
      ...
      likes: 39,
      description:
          'Acapulco se encuentra a la altura de los mejores resorts del mundo. Representa las vacaciones ideales para cualquier exigencia',
      imageUrl: [
