...
class WavePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.quadraticBezierTo(size.width * 0.0393750, size.height * 0.2635000,
    ...
    path.quadraticBezierTo(size.width * 0.7003125, size.height * 0.7015000,
        size.width * 0.6687500, size.height * 0.5000000);
    path.quadraticBezierTo(size.width * 0.6496875, size.height * 0.3340000,
    ...
    path.quadraticBezierTo(size.width * 0.9834375, size.height * 0.5285000,
