...
import 'package:app_projects_bakapp/instagram_redesign/models/ig_user_stories.dart';
import 'package:app_projects_bakapp/instagram_redesign/ui/story/widgets/stories_widgets.dart';

class InstagramStories extends StatefulWidget {
  final IgUserStories stories;
  const InstagramStories({Key? key,required this.stories}) : super(key: key);
