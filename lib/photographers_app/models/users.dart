class PhotoUser {
  ...
  static final julissa = PhotoUser(
      ...
      following: 320,
      photoUrl:
          'https://images.unsplash.com/photo-1525708560449-b469a2d7d1a8?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=334&q=80',
      listPhotosUrl: [
  ...
  static final eduard = PhotoUser(
    ...
    following: 20,
    photoUrl:
        'https://images.unsplash.com/photo-1584013482381-2c276a6fe3ba?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=334&q=80',
    listPhotosUrl: [
