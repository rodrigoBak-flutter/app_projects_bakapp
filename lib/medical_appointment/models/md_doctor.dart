...
class Doctor {
  ...
  const Doctor({
    ...
    this.patients,
    required this.mdAddress,
    required this.rate,
    this.likes,
    this.comments,
    required this.pngPhotoUrl,
